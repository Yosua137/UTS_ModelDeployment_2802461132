...
@st.cache_resource
def load_models():
    classification_model = joblib.load(BASE_DIR / 'artifacts_c' / 'placement_prediction_pipeline.pkl')
    regression_model = joblib.load(BASE_DIR / 'artifacts_r' / 'salary_prediction_pipeline.pkl')
